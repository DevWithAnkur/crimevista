...
const NAV: NavItem[] = [
  ...
  { icon: ShieldAlert, label: "Alerts & Notifications", to: "/alerts", badge: "12" },
    ...
    <>
      ...
      >
        <div className="flex items-center gap-3 px-5 py-5 border-b hairline">
          <div className="w-11 h-11 rounded-lg gold-chip flex items-center justify-center font-bold text-lg font-mono">
            CV
          </div>
          <div className="min-w-0 flex-1">
            <div className="font-bold text-[17px] tracking-tight leading-tight truncate">
              CrimeVista
            </div>
            <div className="text-[10.5px] uppercase tracking-wider text-secondary leading-tight mt-0.5">
              AI Crime Intelligence
            </div>
            <div className="text-[10px] text-secondary/80 leading-tight">
        ...
        <div className="border-t hairline p-3 space-y-2">
          ...
          <div className="panel-inset px-3 py-2.5">
            ...
            <div className="text-[10.5px] text-secondary mt-1">
          ...
          >
            ...
            Logout
            <span className="ml-auto font-mono text-[10px] opacity-60">v2.4.1</span>
          </Link>
        </div>
      </aside>
    </>
